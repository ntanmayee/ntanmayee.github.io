...
In the ninth semester, we are required to work on a 12 credit project. My project is on building a python library for causal inference. I'm working on this with [Chandan Yeshwanth](mailto:Chandan.Yeshwanth@iiitb.org). <!--more-->
